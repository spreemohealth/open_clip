...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        # print("before attn pool in vision transformer: ", x.shape, self.attn_pool)
        ...
        # print("after attn pool in vision transformer: ", pooled.shape, tokens.shape)
        # print("self.proj", self.proj)
        if self.proj is not None:
            pooled = pooled @ self.proj

        # print("after proj", pooled.shape)
