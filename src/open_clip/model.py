...
from .build_towers import _build_vision_tower, CLIPVisionCfg
...
class CustomTextCLIP(nn.Module):
    ...
    def encode_image(self, image, series_mask, normalize: bool = False):
        features = self.visual(image, series_mask)
        return F.normalize(features, dim=-1) if normalize else features
    ...
    def forward(
        ...
        image_features = (
            self.encode_image(image, series_mask, normalize=True)
